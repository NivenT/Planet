...
public:
    Item(crvec4 c, crstring texture, crvec2 extents, crvec2 speed = ITEM_MAX_SPEED, uint16_t type = 0);
    Item(crstring texture, crvec2 extents, crvec2 speed = ITEM_MAX_SPEED, uint16_t type = 0);
    ~Item();
